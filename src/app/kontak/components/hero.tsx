        ...
        <div className="flex flex-col items-center justify-between gap-8 lg:flex-row">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <p className="mx-auto max-w-xl text-lg leading-relaxed text-white/90 lg:mx-0">
              Kami dengan senang hati siap membantu Anda. Jangan ragu untuk menghubungi kami melalui berbagai saluran komunikasi yang tersedia.
            </p>
          </div>
          ...
          <div className="hidden flex-shrink-0 lg:block">
            <div className="relative h-64 w-64">
              <Image
                ...
                alt="Ilustrasi Masjid Al-Muhajirin"
                width={256}
                height={256}
